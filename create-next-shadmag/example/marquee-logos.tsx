...
const MarqueeLogos = () => {
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center gap-4 overflow-hidden rounded-lg border border-neutral-200 bg-white py-20 md:shadow-xl dark:border-neutral-800 dark:bg-neutral-950">
