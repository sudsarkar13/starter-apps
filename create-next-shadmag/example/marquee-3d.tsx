...
const Marquee3D = () => {
  return (
    <div className="relative flex h-full w-96 flex-col items-center justify-center gap-4 overflow-hidden rounded-lg border border-neutral-200 bg-white px-20 md:shadow-xl dark:border-neutral-800 dark:bg-neutral-950">
        ...
        >
          {logos.map((data, idx) => (
            <img
              ...
              src={data.img}
              alt={data.name}
              className="mx-auto h-full w-3/4 cursor-pointer rounded-xl border border-neutral-300 transition-all duration-300 hover:ring-1 hover:ring-neutral-300 dark:border-neutral-800"
            />
          ))}
        </Marquee>
      </div>
